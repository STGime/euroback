			...
			<div class="rounded-xl border border-gray-200 bg-white p-6 space-y-4">
				...
				<ol class="list-decimal pl-5 text-sm text-gray-700 space-y-1.5">
					...
					<li>
						...
						Sessions from a <a href="/docs/account#passkeys" class="text-eurobase-600 hover:underline cursor-pointer">console passkey</a> are refused the same way: a passkey is MFA at Eurobase, not your IdP, so it doesn't satisfy "require SSO". Members keep full access to their own personal projects with password or passkey — only the org's projects need the SSO session. MFA for SSO sign-ins is enforced by your identity provider; Eurobase adds no extra step.
					</li>
					<li>
