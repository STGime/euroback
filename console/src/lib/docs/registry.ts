...
export const chapters: DocChapter[] = [
	...
	{"id": "account", "num": 24, "label": "24. Your Account", "title": "24. Your Account", "description": "Alex wants to set a display name and update their password.", "file": "24-account.svelte"},
