			...
			<div class="border-t border-gray-200 p-4 space-y-3">
				{#if env.PUBLIC_DISCORD_URL}
					<a
						...
						title="Discord is a US-based service. Joining is optional — we don't share your Eurobase account or project data, only what you post there. Discord processes your Discord account under its own terms."
