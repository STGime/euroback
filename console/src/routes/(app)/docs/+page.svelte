...
console.log(stats) // {'{'} total_users: 150, active_today: 23 {'}'}</pre>
		...
		<section id="edge-functions" class="scroll-mt-20">
			...
			<div class="space-y-4">
				...
				<pre class="rounded-lg bg-gray-900 px-4 py-3 text-sm text-green-400 font-mono overflow-x-auto whitespace-pre">import type &#123; EdgeHandler, EdgeContext &#125; from '@eurobase/sdk/functions'
