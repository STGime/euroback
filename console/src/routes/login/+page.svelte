			...
			{#if env.PUBLIC_DISCORD_URL}
				<div class="mt-6 border-t border-gray-200 pt-6 text-center">
					...
					<p class="mt-2 text-xs text-gray-400">
						Discord is a US-based service. Joining is optional — we don't send your
						Eurobase account or project data to Discord, only what you choose to post
						there. Discord processes your Discord account under its own terms.
					</p>
				</div>
			{/if}
		</div>
