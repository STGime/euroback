    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:12px;">
        ...
        <tr><td style="padding:32px;color:#111827;">
          ...
          <p style="margin:0 0 16px;font-size:14px;line-height:1.6;color:#374151;">
            If this wasn't intentional, or you'd like to re-enable Pro (&euro;25/mo per project), reply to this mail or head to <a href="https://console.eurobase.app/p/%s/billing" style="color:#1d4ed8;">the project's billing page</a>.
          </p>
