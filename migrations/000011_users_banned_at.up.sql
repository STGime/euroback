-- 000011_users_banned_at.up.sql
-- Add banned_at column to end-user tables for suspend/disable functionality.
...
-- Add banned_at to existing tenant schemas.
DO $$
DECLARE
    v_schema TEXT;
BEGIN
    ...
    LOOP
        EXECUTE format(
            'ALTER TABLE %I.users ADD COLUMN IF NOT EXISTS banned_at TIMESTAMPTZ', v_schema
        );
    END LOOP;
END;
$$;
