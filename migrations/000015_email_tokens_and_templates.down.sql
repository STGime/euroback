-- 000015_email_tokens_and_templates.down.sql

BEGIN;

-- Drop email_tokens from existing tenant schemas
DO $$
DECLARE
    rec RECORD;
BEGIN
    ...
    LOOP
        IF EXISTS (
            ...
            EXECUTE format('DROP TABLE %I.email_tokens', rec.schema_name);
        END IF;
    END LOOP;
END;
$$;

-- Restore provision_tenant() without email_tokens
...
DROP TABLE IF EXISTS public.platform_email_tokens;
